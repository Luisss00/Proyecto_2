#!/usr/bin/env python
"""Script para eliminar pedido usando nombres de tablas correctos"""
...
def correct_delete_order(order_number):
    """Eliminar pedido usando nombres de tablas correctos"""
    try:
        ...
        print("\n[OK] Proceso de eliminación completado")
        ...
        print(f"[*] Total de pedidos restantes: {remaining_orders}")
...
if __name__ == '__main__':
    ...
    correct_delete_order(order_number)