...
def get_public_config(request):
    ...
    try:
        ...
        public_data = {
            ...
            'banner_title_text': config.banner_title_text,
            'banner_subtitle_text': config.banner_subtitle_text,
            'banner_text_color': config.banner_text_color,
            'enable_products_button': config.enable_products_button,
            'enable_offers_button': config.enable_offers_button,
